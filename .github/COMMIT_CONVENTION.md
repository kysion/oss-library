...
```
feat(oss_modules): 添加支持华为云OBS对象存储
...
- 旧方法: UploadObject(bucket, key, data)
- 新方法: UploadObject(ctx context.Context, req UploadRequest)
